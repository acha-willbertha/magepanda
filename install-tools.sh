...
# ==================================================
# Link Hosting Kalian
ataliomego="raw.githubusercontent.com/yardproject/choycnd/main/ssh"
...
curl https://${ataliomego}/nginx.conf > /etc/nginx/nginx.conf
curl https://${ataliomego}/vps.conf > /etc/nginx/conf.d/vps.conf
...
wget -O /home/vps/public_html/index.html "https://${ataliomego}/index.html1"
